"""
Google Places API client for local places functionality.

Provides functions for searching places, getting place details, and resolving
location text to coordinates using the Google Places API (New).
"""
...
def search_places(request: SearchRequest) -> SearchResponse:
    ...
    Args:
        request: SearchRequest with query, filters, and options.

    Returns:
        SearchResponse with list of matching places and pagination token.
...
def get_place_details(place_id: str) -> PlaceDetails:
    ...
    Returns:
        PlaceDetails with full place information including hours, phone, etc.

    Raises:
        HTTPException: If API request fails or place not found.
    """
...
def resolve_locations(request: LocationResolveRequest) -> LocationResolveResponse:
    ...
    Args:
        request: LocationResolveRequest with text to resolve.

    Returns:
        LocationResolveResponse with matching locations.
